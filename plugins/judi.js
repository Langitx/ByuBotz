...
async function handler(m, { conn, args, isROwner }) {
    ...
    try {
        ...
        if (!(m.sender in confirm)) {
            ...
            let txt = 'Yakin Coy? (iyah/ngga) (60s Timeout)'
            const buttons = [
                {buttonId: `id1`, buttonText: {displayText: 'iyah'}, type: 1},
                {buttonId: `id2`, buttonText: {displayText: 'ngga'}, type: 1}
            ]
