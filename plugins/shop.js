...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) => {
    ...
    const pickaxe = (_pickaxe == 0 ? 20000 : '' || _pickaxe == 1 ? 50000 : '' || _pickaxe == 2 ? 99999 : '' || _pickaxe == 3 ? 149999 : '' || _pickaxe == 4 ? 299999 : 'Diamond Pickaxe')
        const _fishingrod = global.db.data.users[m.sender].fishingrod
    const fishingrod = (_fishingrod == 0 ? 10000 : '' || _fishingrod == 1 ? 20000 : '' || _fishingrod == 2 ? 99999 : '' || _fishingrod == 3 ? 149999 : '' || _fishingrod == 4 ? 299999 : '')
