      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
            this.send2Button(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buy limit*`, '© venz', 'Buy', `${usedPrefix}buy limit`, 'Buy All', `${usedPrefix}buyall`, m)
...
global.dfail = (type, m, conn) => {
  ...
  let msg = {
    ...
    owner: `Hanya Untuk _Owner_!!`,
    mods: `Hanya Untuk Moderator!`,
    premium: 'Perintah ini hanya dapat digunakan oleh _*User Premium.*_',
    group: 'Perintah ini hanya dapat digunakan di grup!',
    private: 'Gunakan Di Chat Pribadi Bot',
    admin: 'Perintah ini hanya untuk *_Admin grup!_*',
    nsfw: `Perintah ini hanya bisa diaktifkan oleh @${global.kontak[0].split`@`[0]}`,
    botAdmin: 'Perintah ini hanya dapat di gunakan saat bot menjadi *_Admin_*',
    unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n#daftar namalu.umurlu\n\nContoh: #daftar pler.16'
  }[type]
